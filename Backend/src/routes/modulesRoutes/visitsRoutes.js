...
// Buscar visita
visitsRouter.get('/visits/search', authenticateUser, checkRoleAgent, getVisitSearchController);
...
visitsRouter.put('/visits/updateStatus', authenticateUser, checkRoleAgent, closeVisitController);
